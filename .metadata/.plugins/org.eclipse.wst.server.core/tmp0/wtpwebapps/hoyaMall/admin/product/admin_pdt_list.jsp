...
<td><img src="/hoyaMall/product/pdt_img/<%=pdtList.get(i).getPl_img1() %>" width="100" height="100" /></td>
...
<td>
	<div class="pdtBox<%=max%>">
		<%=lnk %><img src="/hoyaMall/product/pdt_img/<%=pdtList.get(i).getPl_img1() %>" width="<%=max == 3 ? 250 : 190 %>" height="<%=max == 3 ? 200 : 140 %>" /></a><br />
...
<td width="10%">
	<input type="button" value="상품 등록" onclick="location.href='admin_product_in_form.apdt';" />
</td>
</tr>
</table>
</body>
