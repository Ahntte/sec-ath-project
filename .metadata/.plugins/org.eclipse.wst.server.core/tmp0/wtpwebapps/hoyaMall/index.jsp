...
ArrayList<PdtInfo> pdtMainBpList = (ArrayList<PdtInfo>)request.getAttribute("pdtMainBpList");
  ...
  <head>
	...
	margin-right:10px;
      ...
      */
      ...
      #slide {
      	background-image: url("images/아호야1.jpg");
        background-repeat: no-repeat;
        background-size: cover;
        background-position: center;
        animation: fadefbackground 9s infinite;
        
      }
        @keyframes fadefbackground {
       	0% {
          background-image: url("images/아호야1.jpg");
        }
        33.3% {
          background-image: url("images/아호야3.jpg");
        }
       	67% {
          background-image: url("images/아호야2.jpg");
        }
        100% {
        background-image: url("images/아호야1.jpg");
        }
      ...
      .aside{
      background-image: url("images/hoya_deco.jpg");
      background-repeat: no-repeat;
      background-size: cover;
      background-position: center;
...
%>
      ...
      <main class="mainWrap">
      <h1 style="text-align:center;">BEST PLANTS</h1>
      <article class="bestContainer">
	 <section class="bestWrap">
	 <% for(int i = 0 ; i < pdtMainBpList.size() ; i++) { %>
	  <div class="bestItem">
	  <div class="image">
	 	<img src="/hoyaMall/product/pdt_img/<%=pdtMainBpList.get(i).getPl_img1() %>" width="400px" height="400px"/>
	  </div>
	  	<div class="fntCenter"><%=pdtMainBpList.get(i).getPl_name() %></div>
	  	<div class="fntCenter"><%=pdtMainBpList.get(i).getPl_price() %></div>
	  </div>
	 <% } %>
	 </section>
	</article>
